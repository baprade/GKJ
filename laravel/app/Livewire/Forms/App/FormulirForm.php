...
class FormulirForm extends Form
{
    public ?Formulir $post;
    ...
    public function setForm(Form $post)
    {
        $this->post = $post;
        $this->id = $post->id;
    ...
    public function update()
    {
        ...
        if ($this->photo_file_post && $this->photo_file_post->isValid()) {
            ...
            $del_photo = Form::findOrFail($this->id)->photo_file;

            $this->deleteFilesByNameWithoutExtension($del_photo);
        } else {
            $this->photo_file_post = Form::findOrFail($this->id)->photo_file;
        }
        ...
        Form::findOrFail($this->id)->update($updateForm);
