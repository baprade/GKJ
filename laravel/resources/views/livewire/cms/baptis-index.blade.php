                    ...
                    <table class="w-full">
                        <thead>
                            <tr>
                                ...
                                <x-cms.th title="Nama I" class="text-start"/>
                                <x-cms.th title="Anggota Kelompok" class="text-start"/>
                                <x-cms.th title="Anggota Gereja" class="text-start"/>
                                <x-cms.th title="Nomor Induk" class="text-start"/>
                                <x-cms.th title="Alamat Lengkap" class="text-start"/>
                                <x-cms.th title="Nama II" class="text-start"/>
                                <x-cms.th title="Anggota Kelompok" class="text-start"/>
                                <x-cms.th title="Anggota Gereja" class="text-start"/>
                                <x-cms.th title="Nomor Induk" class="text-start"/>
                                <x-cms.th title="Alamat Lengkap" class="text-start"/>
                                ...
                                <x-cms.th title="Tanggal Melapor ke Catatan Sipil" class="text-start"/>
                                <x-cms.th title="Akta Kelahiran" class="text-start"/>
    ...
    @if ($items->isNotEmpty())
        @foreach ($items as $item)
                            <tr wire:key="{{ $item->id }}" class="border-t border-slate-200 hover:bg-slate-100 hover:text-black">
                                ...
                                <td class="px-2 text-sm">{{ $item->nama_1 }}</td>
                                <td class="px-2 text-sm">{{ $item->anggota_kelompok_1 }}</td>
                                <td class="px-2 text-sm">{{ $item->anggota_gereja_1 }}</td>
                                <td class="px-2 text-sm">{{ $item->nomor_induk_1 }}</td>
                                <td class="px-2 text-sm">{{ $item->alamat_1 }}</td>
                                <td class="px-2 text-sm">{{ $item->nama_2 }}</td>
                                <td class="px-2 text-sm">{{ $item->anggota_kelompok_2 }}</td>
                                <td class="px-2 text-sm">{{ $item->anggota_gereja_2 }}</td>
                                <td class="px-2 text-sm">{{ $item->nomor_induk_2 }}</td>
                                <td class="px-2 text-sm">{{ $item->alamat_2 }}</td>
                                <td class="px-2 text-sm">{{ $item->nama_anak }}</td>
                                <td class="px-2 text-sm">{{ $item->jenis_kelamin_anak->title }}</td>
                                <td class="text-xs text-center max-w-20 min-w-20">{{ $item->tempat_lahir }}</td>
                                ...
                                <td class="px-2 text-sm">{{ $item->akta_lahir }}</td>
