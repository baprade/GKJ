                    ...
                    <table class="w-full">
                        <thead>
                            <tr>
                                ...
                                <x-cms.th title="Nama Meninggal" class="text-start"/>
                                ...
                                <x-cms.th title="No Induk Gereja" class="text-start"/>
    ...
    @if ($items->isNotEmpty())
        @foreach ($items as $item)
                            <tr wire:key="{{ $item->id }}" class="border-t border-slate-200 hover:bg-slate-100 hover:text-black">
                                ...
                                <td class="px-2 text-sm">{{ $item->nama_meninggal }}</td>
                                ...
                                <td class="px-2 text-sm">{{ $item->no_induk_gereja }}</td>
