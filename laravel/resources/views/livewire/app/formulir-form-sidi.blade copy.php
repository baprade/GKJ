...
<div id="titip-warga" class="flex flex-col gap-4 p-6 grow sm:p-8 lg:p-10 sm:gap-6">
    ...
    <form wire:submit.prevent="send" class="flex flex-col gap-6">
        ...
        <div class="grid gap-4 sm:gap-6 sm:grid-cols-2">
            ...
            <x-app.label-select-kristen-form/>
            ...
            <x-app.label-input-text name="lama_katekasi" title="Selama"/>
            <x-app.label-input-text name="tempat_katekasi" title="Tempat"/>

            {{-- 9 --}}
            <x-app.label-input-text name="tanggal_sidi" title="Tanggal SIDI"/>
            ...
            <x-app.label-input-text name="tanggal_melapor" title="Tanggal Melapor"/>
